...
pub struct FIX50SP1CrackerUtils;
// parse string (35=D) into Field{35, "D"}
impl FIX50SP1CrackerUtils {
...
impl std::fmt::Display for SideQtyField {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}={}|", Self::tag(), self.value())
    }
}
impl TryFrom<&Field> for SideQtyField {
    type Error = UnknownMsgTypeError;
...
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct UndlyInstrumentPartyIDField {
    pub fd: Field,
}

impl UndlyInstrumentPartyIDField {
    #[must_use]
    pub const fn tag() -> u16 {
        1059
    }
...
impl std::fmt::Display for UndlyInstrumentPartyIDField {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}={}|", Self::tag(), self.value())
    }
}
impl TryFrom<&Field> for UndlyInstrumentPartyIDField {
    type Error = UnknownMsgTypeError;
...
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct UndlyInstrumentPartyIDSourceField {
    pub fd: Field,
}

impl UndlyInstrumentPartyIDSourceField {
    #[must_use]
    pub const fn tag() -> u16 {
        1060
    }
...
impl std::fmt::Display for UndlyInstrumentPartyIDSourceField {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}={}|", Self::tag(), self.value())
    }
}
impl TryFrom<&Field> for UndlyInstrumentPartyIDSourceField {
    type Error = UnknownMsgTypeError;
...
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct UndlyInstrumentPartyRoleField {
    pub fd: Field,
}

impl UndlyInstrumentPartyRoleField {
    #[must_use]
    pub const fn tag() -> u16 {
        1061
    }
...
impl std::fmt::Display for UndlyInstrumentPartyRoleField {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}={}|", Self::tag(), self.value())
    }
}
impl TryFrom<&Field> for UndlyInstrumentPartyRoleField {
    type Error = UnknownMsgTypeError;
...
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct UndlyInstrumentPartySubIDField {
    pub fd: Field,
}

impl UndlyInstrumentPartySubIDField {
    #[must_use]
    pub const fn tag() -> u16 {
        1063
    }
...
impl std::fmt::Display for UndlyInstrumentPartySubIDField {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}={}|", Self::tag(), self.value())
    }
}
impl TryFrom<&Field> for UndlyInstrumentPartySubIDField {
    type Error = UnknownMsgTypeError;
...
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct UndlyInstrumentPartySubIDTypeField {
    pub fd: Field,
}

impl UndlyInstrumentPartySubIDTypeField {
    #[must_use]
    pub const fn tag() -> u16 {
        1064
    }
...
impl std::fmt::Display for UndlyInstrumentPartySubIDTypeField {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}={}|", Self::tag(), self.value())
    }
}
impl TryFrom<&Field> for UndlyInstrumentPartySubIDTypeField {
    type Error = UnknownMsgTypeError;
...
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct OptPayAmountField {
    pub fd: Field,
}

impl OptPayAmountField {
    #[must_use]
    pub const fn tag() -> u16 {
        1195
    }
...
impl std::fmt::Display for OptPayAmountField {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}={}|", Self::tag(), self.value())
    }
}
impl TryFrom<&Field> for OptPayAmountField {
    type Error = UnknownMsgTypeError;
...
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct FuturesValuationMethodField {
    pub fd: Field,
}

impl FuturesValuationMethodField {
    #[must_use]
    pub const fn tag() -> u16 {
        1197
    }
...
impl std::fmt::Display for FuturesValuationMethodField {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}={}|", Self::tag(), self.value())
    }
}
impl TryFrom<&Field> for FuturesValuationMethodField {
    type Error = UnknownMsgTypeError;
...
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct DerivativeFuturesValuationMethodField {
    pub fd: Field,
}

impl DerivativeFuturesValuationMethodField {
    #[must_use]
    pub const fn tag() -> u16 {
        1319
    }
...
impl std::fmt::Display for DerivativeFuturesValuationMethodField {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}={}|", Self::tag(), self.value())
    }
}
impl TryFrom<&Field> for DerivativeFuturesValuationMethodField {
    type Error = UnknownMsgTypeError;
